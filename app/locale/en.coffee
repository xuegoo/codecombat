module.exports = nativeDescription: "English", englishDescription: "English", translation:
  ...
  premium_features:
    ...
    hero_blurb_1: "Get access to __heroesCount__ super-charged subscriber-only heroes heroes! Harness the unstoppable power of Okar Stompfoot, the deadly precision of Naria of the Leaf, or summon \"adorable\" skeletons with Nalfar Cryptor."
    ...
    list_gems: "Receive gems every month to buy gear, pets, and heroes"
    list_levels: "Access __levelsCount__ more levels to explore"
    list_heroes: "Unlock exclusive heroes, include Ranger and Wizard classes"
    list_game_dev: "Make and share levels and games with friends"
    list_web_dev: "Build websites and interactive apps"
    list_items: "Equip premium-only items for your Rangers and Wizards as well as Pets!"
    list_support: "Get Premium support to help you get unstuck"
